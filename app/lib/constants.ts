...
export const STORIES_TITLE = [
    ...
    {   lang: 'FR',
        content: 'Mes dernières réalisations'
    }
]
export const FOOTER = [
    {
...
export const BUSSHI_BIO = [
    {
        lang: 'EN',
        content: 'Full-stack developper freelance, aspiring pentester, infosec lover, check out some of my personnal projects here...'
    },
    {
        lang: 'FR',
        content: 'Développeur fullstack freelance, passionné de cybersécurité, explorez ici quelques-uns de mes projets personnels...'
    }
]
export const LINKS = [
    {
